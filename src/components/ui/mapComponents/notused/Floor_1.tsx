...
//     const updateGridCell = (y: number, x: number, value: CellType): void => {
...
//                 updateGridCell(y, x, "classroom");
//             }
//         }
//         updateGridCell(room.entry.y, room.entry.x, "start");
//     });
...
//                 updateGridCell(y, x, "elevator");
//             }
//         }
//         updateGridCell(elevator.entry.y, elevator.entry.x, "start");
//     });
...
//                 updateGridCell(y, x, "bathroom");
//             }
//         }
//         updateGridCell(bathroom.entry.y, bathroom.entry.x, "start");
//     });

//     // Mark fire equipment
//     floorData.fireEquipment.forEach((equipment) => {
//         updateGridCell(equipment.location.y, equipment.location.x, "fireEquipment");
//     });
...
//         for (let x = room.start.x; x <= room.end.x; x++) {
//             for (let y = room.start.y; y <= room.end.y; y++) {
//                 updateGridCell(y, x, "utilityRoom");
//             }
//         }
//     });
