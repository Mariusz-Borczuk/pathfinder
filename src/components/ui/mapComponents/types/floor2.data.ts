...
const floor2Data: FloorData = {
    classrooms: [
        { number: "201", start: { x: 49, y: 38 }, end: { x: 53, y: 47 }, entry: { x: 49, y: 42 } },
        { number: "202", start: { x: 49, y: 35 }, end: { x: 53, y: 36 }, entry: { x: 49, y: 35 } },
        { number: "203", start: { x: 49, y: 30 }, end: { x: 53, y: 32 }, entry: { x: 49, y: 31 } },
        { number: "204", start: { x: 49, y: 25 }, end: { x: 53, y: 27 }, entry: { x: 49, y: 26 } },
        { number: "205", start: { x: 49, y: 20 }, end: { x: 53, y: 22 }, entry: { x: 49, y: 21 } },
        { number: "206", start: { x: 49, y: 15 }, end: { x: 53, y: 17 }, entry: { x: 49, y: 16 } },
        { number: "207", start: { x: 49, y: 10 }, end: { x: 53, y: 12 }, entry: { x: 49, y: 11 } },
        { number: "208", start: { x: 49, y: 5 }, end: { x: 53, y: 7 }, entry: { x: 49, y: 6 } },
    ],
    elevators: [
