...
export const floor4Data: FloorData = {
    classrooms: [
        ...
        { number: "401", start: { x: 49, y: 36 }, end: { x: 52, y: 39 }, entry: { x: 49, y: 38 } },
        { number: "402", start: { x: 49, y: 31 }, end: { x: 52, y: 34 }, entry: { x: 49, y: 32 } },
        { number: "403", start: { x: 49, y: 26 }, end: { x: 52, y: 29 }, entry: { x: 49, y: 28 } },
        ...
        { number: "422", start: { x: 3, y: 24 }, end: { x: 7, y: 28 }, entry: { x: 7, y: 26 } },
        { number: "423", start: { x: 3, y: 30 }, end: { x: 7, y: 33 }, entry: { x: 7, y: 31 } },
        { number: "424", start: { x: 3, y: 35 }, end: { x: 7, y: 36 }, entry: { x: 7, y: 35 } },
        { number: "425", start: { x: 3, y: 37 }, end: { x: 7, y: 38 }, entry: { x: 7, y: 37 } },
        { number: "426", start: { x: 3, y: 40 }, end: { x: 7, y: 47 }, entry: { x: 7, y: 44 } },
        { number: "434", start: { x: 41, y: 42 }, end: { x: 45, y: 49 }, entry: { x: 45, y: 45 } },
        { number: "AULA A", start: { x: 17, y: 40 }, end: { x: 39, y: 52 }, entry: [
                { x: 17, y: 44 }, 
                { x: 39, y: 50 }
            ] 
        }
